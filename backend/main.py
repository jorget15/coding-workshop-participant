...
# ---------------------------------------------------------------------------
# NOTE: Each Lambda's function.py already sets the prefix on its router
# (e.g. prefix="/auth", prefix="/individuals"), so we mount them without
# duplicating the prefix here.
